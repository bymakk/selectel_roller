...
![Два аккаунта Selectel: регионы, события, совпадения и промахи по /24](docs/images/selectel-scanner-dual-dashboard.png)
...
- `temp/selectel-scanner-state.json` — сохраненные матчи.
- `temp/scanner.log` — лог, если запустил с `--log-file`.
